...
<script>
    ...
    // 百度地图资源加载 
    const resourcesUrl = ['//api.map.baidu.com/getscript?v=2.0&ak=qp02aVl6tUyI3xKRBCeBqH8mjBICZHgs&services=false', './src/libs/DrawingManager_min.js', './src/libs/SearchInfoWindow_min.js'];
